"""
Django settings for smb_meet_test_47006 project.
...
ROOT_URLCONF = 'smb_meet_test_47006.urls'
...
WSGI_APPLICATION = 'smb_meet_test_47006.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "smb_meet_test_47006 API",
    "DESCRIPTION": "API documentation for smb_meet_test_47006 App",
    "VERSION": "v1",
}
